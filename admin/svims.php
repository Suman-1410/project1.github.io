        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li >
                        <a href="add_courses.php" ><i class="fa fa-desktop "></i>Add Courses</a>
                    </li>
                   </ul>
            </div>
...
<h1 style="text-align: center;">SVIMS COURSES</h1>
...
$selecrquery = "select * from details ";
...
?>
    <tr>
            ...
            <td><?php echo '<a href="' . $res['wlink'] . '">link'; ?></td>
                        ...
                        <td><a href="update.php?id=<?php echo $res['id']; ?>" data-toggle="tooltip" data-placement="right" title="Edit"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
