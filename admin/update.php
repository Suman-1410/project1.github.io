...
$ids = $_GET['id'];
$showquery = "select * from details where id={$ids}";
...
if(isset($_POST['submit'])){
  ...
  $query = "update details set id=$ids, courses='$courses', t_tuition_fees='$t_tuition_fees', eligibility='$eligibility', duration='$duration', clevel='$clevel', wlink='$wlink' where id=$idupdate ";
