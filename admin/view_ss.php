        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li >
                        <a href="submit_ss.php" ><i class="fa fa-desktop "></i>Submitted scholarships</a>
                    </li>
                   </ul>
            </div>
...
<table id="table">
  <tr>
    ...
    <th>scholar_amount</th>
    <th>scholar_provider</th>
    <th>scholar_eligibility</th>
    <th>scholar_requirment</th>
    <th>scholar_link</th>
    <th>Created_at</th>
...
$selecrquery = "select * from au_sholarships ";
...
?>
    <tr>
            <td><?php echo $res['id']; ?></td>
                        ...
                        <td><a href="scholarships_update.php?id=<?php echo $res['id']; ?>" data-toggle="tooltip" data-placement="right" title="Edit"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
