 ...
 <nav>
    ...
    <style>
      ...
      <ul>
        ...
        <li>
               <a class="active" href="#"> <i class="fas fa-sign-in-alt fa-2x"></i>
               <i class="fas fa-caret-down fa-1x"></i>
               </a>
               <ul>
                  <li><a href="admin/admin_login.php#"> <i class="fa fa-id-badge"></i> Admin</a></li>
                  <li><a href="login.php#"> <i class="fas fa-sign-in-alt"></i> user login</a></li>
        ...
        <li class="nav-item">
            <a class="" aria-current="page" href="ssregister.php">Submit Scholarship</a>
        </li>
...
<h3><b>Welcome Back to SCHOLARSERA</b></h3>
<p>We’re glad to see you again! Log in to view your latest scholarship matches, complete your student profile, and access new scholarship and college recruiting opportunities just for you. Simply log back in to be automatically entered into the <b>SCHOLARSERA</b>.</p>
<hr>
...
<p>New to SCHOLARSERA? Click <a href="register.php">here</a> to start your free scholarship search.</p>
</div>
<br>
<br>
<br>
